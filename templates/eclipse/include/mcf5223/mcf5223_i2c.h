 ...
 * Based on MCF52235 Reference Manual, Chapter 27
 *
...
/*********************************************************************  
 * I2DR bit definitions I2C Data Register
**********************************************************************/
 ...
 *   IC = 0x38 (divider = 640, closest match)
 *
 * For 60MHz system clock and 400kHz I2C:
 *   Divider = 60MHz / 400kHz = 150
 *   IC = 0x0D (divider = 160, closest match)
 *********************************************************************/

/* Common I2FDR values for 60MHz system clock */
#define MCF_I2C_I2FDR_100KHZ    (0x38)      /* ~94kHz (divider 640) */
#define MCF_I2C_I2FDR_400KHZ    (0x0D)      /* ~375kHz (divider 160) */
