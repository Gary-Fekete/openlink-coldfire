 ...
 * Based on MCF52235 Reference Manual, Chapter 25
 *
...
#define MCF_QSPI_QMR_BITS(x)    (((x) & 0x000F) << 10)   /* Bits per transfer */
...
#define MCF_QSPI_QMR_BITS_8     (0x0008)    /* 8 bits (when BITS=1000) */
