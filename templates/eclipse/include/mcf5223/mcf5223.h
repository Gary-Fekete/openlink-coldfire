...
/* Compatibility: Some Freescale headers use __IPSBAR as a linker symbol.
 * This macro allows those headers to work with our IPSBAR define. */
#ifndef __IPSBAR
#define __IPSBAR                ((uint8*)IPSBAR)
#endif
